...
{
    public partial class BoatResults : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectedTime = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RaceResults_BoatDetail_BoatDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RaceResults_BoatDetailsId",
                table: "RaceResults",
